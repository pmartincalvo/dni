...
REGEX_FOR_8_DIGIT_NUMBER = "(?<![1-9]{1})([1-9]{8})(?![1-9]{1})"
REGEX_FOR_FULL_DNI_WITH_POSSIBLE_CLUTTER = (
    f"{REGEX_FOR_8_DIGIT_NUMBER}.*{REGEX_FOR_UPPER_OR_LOWER_CHECK_LETTERS}"
)
REGEX_FOR_NOT_A_DNI_CHAR = f"[^1-9{UPPER_AND_LOWER_CASE_CHECK_LETTERS}]"
